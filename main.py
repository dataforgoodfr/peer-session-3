...
logger.debug(f"DATABASE_NAME: {os.environ.get('DATABASE_NAME')}")
logger.debug(f"DATABASE_USER: {os.environ.get('DATABASE_USER')}")
logger.debug(f"DATABASE_PASSWORD: {os.environ.get('DATABASE_PASSWORD')}")
